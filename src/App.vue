        ...
        <div style="display: flex;flex-direction: column;align-items: center;">
          ...
          >
            <template v-slot:subtitle>
              <span class="leleo-card-subtitle">项目原作者：<a href="https://github.com/leleo886" target="_blank"
                                                              style="text-decoration: none; color: inherit;">leleo</a>
              </span><br>
              <span class="leleo-card-subtitle">本项目作者：<a href="https://github.com/LuvGaze" target="_blank"
                                                              style="text-decoration: none; color: inherit;">LuvGaze</a>
              </span><br>
